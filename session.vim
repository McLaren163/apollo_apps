...
set pyxversion=3
set ruler
set runtimepath=~/.vim,~/.vim/plugged/nerdtree/,~/.vim/plugged/jedi-vim/,~/.vim/plugged/gruvbox/,~/.vim/plugged/vim-easymotion/,~/.vim/plugged/vim-jinja/,~/.vim/plugged/python-mode/,~/.vim/plugged/tagbar/,~/.vim/plugged/FixedTaskList.vim/,~/.vim/plugged/lightline.vim/,/usr/share/vim/vimfiles,/usr/share/vim/vim81,/usr/share/vim/vimfiles/after,~/.vim/plugged/jedi-vim/after,~/.vim/plugged/python-mode/after,~/.vim/after
set shiftround
set shiftwidth=4
set smarttab
set softtabstop=4
...
exe 'vert 2resize ' . ((&columns * 119 + 96) / 192)
exe 'vert 3resize ' . ((&columns * 40 + 96) / 192)
argglobal
enew
file NERD_tree_1
let s:cpo_save=&cpo
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 18 - ((9 * winheight(0) + 21) / 43)
...
setlocal spellfile=
setlocal spelllang=en
setlocal statusline=%#StatusLineNC#[Name]\ pdf_creator.py
setlocal suffixesadd=
setlocal noswapfile
setlocal synmaxcol=3000
if &syntax != 'tagbar'
...
tabnext 1
badd +6 main.py
badd +128 src/pdf_creator.py
badd +43 src/models.py
